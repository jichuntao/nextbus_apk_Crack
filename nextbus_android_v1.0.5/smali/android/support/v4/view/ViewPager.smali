...
.field private static final ac:Landroid/support/v4/view/bg;
...
.field private V:Landroid/support/v4/view/bc;

.field private W:Landroid/support/v4/view/bc;

.field private X:Landroid/support/v4/view/bb;

.field private Y:Landroid/support/v4/view/bd;
...
.field private m:Landroid/support/v4/view/be;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->ac:Landroid/support/v4/view/bg;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Landroid/support/v4/view/ViewPager;->ae:I
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/ay;
...
.method private a(IZIZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/ay;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->V:Landroid/support/v4/view/bc;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->V:Landroid/support/v4/view/bc;

    invoke-interface {v0, p1}, Landroid/support/v4/view/bc;->onPageSelected(I)V

    :cond_0
    if-eqz p4, :cond_1

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bc;
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->V:Landroid/support/v4/view/bc;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->V:Landroid/support/v4/view/bc;

    invoke-interface {v2, p1}, Landroid/support/v4/view/bc;->onPageSelected(I)V

    :cond_3
    if-eqz p4, :cond_4

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bc;
...
.method private a(Landroid/support/v4/view/ay;ILandroid/support/v4/view/ay;)V
    .locals 11
    ...
    iget v0, p3, Landroid/support/v4/view/ay;->b:I

    iget v1, p1, Landroid/support/v4/view/ay;->b:I

    if-ge v0, v1, :cond_3

    iget v1, p3, Landroid/support/v4/view/ay;->e:F

    iget v2, p3, Landroid/support/v4/view/ay;->d:F
    ...
    iget v3, p3, Landroid/support/v4/view/ay;->e:F
    ...
    iget v2, p1, Landroid/support/v4/view/ay;->e:F
    ...
    iget v0, p1, Landroid/support/v4/view/ay;->e:F
    ...
    iget v3, p1, Landroid/support/v4/view/ay;->d:F
    ...
    iget v1, p1, Landroid/support/v4/view/ay;->d:F
...
.method private b(Z)V
    ...
    invoke-static {v4, v0, v5}, Landroid/support/v4/view/ad;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
...
.method private d(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->h()Landroid/support/v4/view/ay;
    ...
    iget v5, v1, Landroid/support/v4/view/ay;->b:I
    ...
    iget v6, v1, Landroid/support/v4/view/ay;->e:F
...
.method private g()V
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/az;->a:Z
...
.method private h()Landroid/support/v4/view/ay;
    .locals 13
...
.method private setScrollState(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Y:Landroid/support/v4/view/bd;
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/bc;->onPageScrollStateChanged(I)V
...
.method a(II)Landroid/support/v4/view/ay;
    .locals 2
...
.method a(Landroid/view/View;)Landroid/support/v4/view/ay;
    .locals 4
...
.method a()V
    ...
    invoke-static {p0, v4}, Landroid/support/v4/view/ad;->b(Landroid/view/View;I)V
...
.method a(I)V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/ay;
    ...
    iget v10, v6, Landroid/support/v4/view/ay;->d:F
    ...
    :cond_2
    iget v3, v6, Landroid/support/v4/view/ay;->d:F
    ...
    :cond_3
    invoke-direct {p0, v6, v4, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/ay;ILandroid/support/v4/view/ay;)V
    ...
    iget-object v0, v6, Landroid/support/v4/view/ay;->a:Ljava/lang/Object;
    ...
    iput v1, v0, Landroid/support/v4/view/az;->f:I

    iget-boolean v5, v0, Landroid/support/v4/view/az;->a:Z

    if-nez v5, :cond_6

    iget v5, v0, Landroid/support/v4/view/az;->c:F
    ...
    invoke-virtual {p0, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ay;
    ...
    iput v6, v0, Landroid/support/v4/view/az;->c:F

    iget v5, v5, Landroid/support/v4/view/ay;->b:I

    iput v5, v0, Landroid/support/v4/view/az;->e:I
    ...
    invoke-virtual {p0, v5, v0}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/ay;
    ...
    iget-boolean v7, v0, Landroid/support/v4/view/ay;->c:Z
    ...
    :cond_16
    invoke-virtual {p0, v5, v3}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/ay;
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->ac:Landroid/support/v4/view/bg;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Landroid/support/v4/view/ay;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ay;
...
.method protected a(IFI)V
    ...
    iget-boolean v9, v0, Landroid/support/v4/view/az;->a:Z
    ...
    :cond_1
    iget v0, v0, Landroid/support/v4/view/az;->b:I
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/view/bc;->onPageScrolled(IFI)V
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->Y:Landroid/support/v4/view/bd;

    invoke-interface {v5, v3, v0}, Landroid/support/v4/view/bd;->a(Landroid/view/View;F)V
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ay;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-boolean v2, v0, Landroid/support/v4/view/az;->a:Z

    instance-of v3, p1, Landroid/support/v4/view/ax;

    or-int/2addr v2, v3

    iput-boolean v2, v0, Landroid/support/v4/view/az;->a:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/az;->d:Z
...
.method b(I)Landroid/support/v4/view/ay;
    .locals 3
...
.method b(Landroid/view/View;)Landroid/support/v4/view/ay;
    .locals 2
    ...
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ay;
...
.method b()V
    ...
    iget-boolean v6, v0, Landroid/support/v4/view/az;->a:Z
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/view/az;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v0, v0, Landroid/support/v4/view/az;->f:I
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v1, Landroid/support/v4/view/az;

    iget-boolean v7, v1, Landroid/support/v4/view/az;->a:Z

    if-eqz v7, :cond_4

    iget v7, v1, Landroid/support/v4/view/az;->b:I

    and-int/lit8 v7, v7, 0x7

    iget v1, v1, Landroid/support/v4/view/az;->b:I
    ...
    iget-boolean v12, v1, Landroid/support/v4/view/az;->a:Z

    if-nez v12, :cond_2

    move-object/from16 v0, p0

    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ay;
    ...
    iget-boolean v13, v1, Landroid/support/v4/view/az;->d:Z

    if-eqz v13, :cond_1

    const/4 v13, 0x0

    iput-boolean v13, v1, Landroid/support/v4/view/az;->d:Z
    ...
    iget v1, v1, Landroid/support/v4/view/az;->c:F
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/view/az;->a:Z

    if-eqz v1, :cond_3

    iget v1, v0, Landroid/support/v4/view/az;->b:I
    ...
    :cond_2
    :goto_3
    iget v4, v0, Landroid/support/v4/view/az;->width:I
    ...
    iget v2, v0, Landroid/support/v4/view/az;->width:I
    ...
    :goto_4
    iget v11, v0, Landroid/support/v4/view/az;->height:I
    ...
    iget v0, v0, Landroid/support/v4/view/az;->height:I
    ...
    iget v0, v0, Landroid/support/v4/view/az;->c:F
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ay;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v5, v4, Landroid/support/v4/view/ay;->b:I
    ...
    iget v3, v4, Landroid/support/v4/view/ay;->e:F

    sub-float/2addr v2, v3

    iget v3, v4, Landroid/support/v4/view/ay;->d:F
...
.method public setAdapter(Landroid/support/v4/view/x;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/be;
    ...
    new-instance v1, Landroid/support/v4/view/be;

    invoke-direct {v1, p0, v5}, Landroid/support/v4/view/be;-><init>(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/au;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/be;

    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/x;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/be;
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->X:Landroid/support/v4/view/bb;
    ...
    invoke-interface {v1, v0, p1}, Landroid/support/v4/view/bb;->a(Landroid/support/v4/view/x;Landroid/support/v4/view/x;)V
...
.method setChildrenDrawingOrderEnabledCompat(Z)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Z:Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->Z:Ljava/lang/reflect/Method;
    :try_end_0
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/bb;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->X:Landroid/support/v4/view/bb;

    return-void
.end method

.method public setOnPageChangeListener(Landroid/support/v4/view/bc;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->V:Landroid/support/v4/view/bc;
